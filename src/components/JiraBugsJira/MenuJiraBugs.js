...
export default function MenuJiraBugs() {
    return (
        <div className="menu">
            <div className="account">
                <div className="avatar">
                    <img src="https://picsum.photos/200/300" alt="123" />
                </div>
            ...
            <div className="control">
                <div>
                    ...
                    <NavLink className="text-dark" activeStyle={{ color: 'blue' }} to="/jirabugs" activeClassName="active font-weight-bold text-primary" >Cyber Board</NavLink>
                </div>
                <div>
